!================================================================
      ...
      allocate(NBias(1:umbrellaLimit),
     &              STAT = AllocateStatus)
      allocate(NHist(1:umbrellaLimit),
     &              STAT = AllocateStatus)
      allocate(E_Avg(1:umbrellaLimit),
     &              STAT = AllocateStatus)  
      if(biasIon) then
        allocate(NR_Hist(1:umbrellaLimit, 0:rBins),
     &              STAT = AllocateStatus)
        allocate(NR_Bias(1:umbrellaLimit, 0:rBins),
     &              STAT = AllocateStatus)          
        NR_Bias = 0d0
        NR_Hist = 0d0     
        dR = 20d0/dble(rBins)
...
!==========================================================================================
     ...
     &              STAT = AllocateStatus)     
      ...
      allocate(arrayIndx(1:nMolTypes),
     &              STAT = AllocateStatus)
