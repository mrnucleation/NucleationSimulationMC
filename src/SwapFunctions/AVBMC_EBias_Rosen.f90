...
!===================================================================================
      ...
      real(kind(0.0d0)) :: genProbRatio, rosenRatio
...
!      write(2,*) ProbTarg_Out, ProbSel_Out, avbmc_vol, gas_dens(nType), ProbTarg_In 
!      write(2,*) E_Inter, E_Intra, genProbRatio, rosenRatio, bias_diff
!      write(2,*)
...
!===================================================================================            
      ...
      interface
        subroutine EBias_Remove_ChooseNeighbor(nTarget, biasArray, nSel, ProbTarget)
          ...
          real(kind(0.0d0)), intent(in) :: biasArray(:)  
      ...
      real(kind(0.0d0)) :: rx, ry, rz, dist, rosenRatio
      real(kind(0.0d0)) :: biasArray(1:nMolTypes)
...
!=================================================================================    
      ...
      integer :: NDiff(1:nMolTypes)
      real(kind(0.0d0)) :: biasArray(1:nMolTypes)
      real(kind(0.0d0)) :: norm, bias_diff, biasOld, biasNew       
