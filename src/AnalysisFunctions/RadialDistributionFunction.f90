...
!      perform radial distribution studies
   ...
   !--------------------------------------------------------------------------------
      ...
      allocate( type1(1:iRadial), stat = AllocationStatus )
      allocate( type2(1:iRadial), stat = AllocationStatus )
      allocate( atom1(1:iRadial), stat = AllocationStatus )
      allocate( atom2(1:iRadial), stat = AllocationStatus )
      allocate( radHistIndx(1:iRadial), stat = AllocationStatus )
